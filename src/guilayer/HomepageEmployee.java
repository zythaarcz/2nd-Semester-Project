	...
	public HomepageEmployee() {
		...
		gl_contentPane.setHorizontalGroup(gl_contentPane.createParallelGroup(Alignment.LEADING)
				.addGroup(gl_contentPane.createSequentialGroup().addGap(11)
						.addComponent(panel, GroupLayout.DEFAULT_SIZE, 424, Short.MAX_VALUE).addGap(11))
				.addGroup(Alignment.TRAILING, gl_contentPane.createSequentialGroup().addGroup(gl_contentPane
						...
						.addGroup(gl_contentPane.createSequentialGroup().addGap(15).addComponent(statisticsPanel,
								GroupLayout.PREFERRED_SIZE, 417, Short.MAX_VALUE)))
						.addGap(14)));
		gl_contentPane.setVerticalGroup(gl_contentPane.createParallelGroup(Alignment.LEADING)
				.addGroup(gl_contentPane.createSequentialGroup().addContainerGap()
						.addGroup(gl_contentPane.createParallelGroup(Alignment.LEADING).addComponent(sidebarButton)
						...
						.addGap(18).addComponent(panel, GroupLayout.PREFERRED_SIZE, 129, GroupLayout.PREFERRED_SIZE)
		...
		manageBlogsButton.addActionListener(e -> {
			...
			abEmployee.setLocationRelativeTo(null);
		...
		gl_panel.setHorizontalGroup(gl_panel.createParallelGroup(Alignment.LEADING).addGroup(gl_panel
				...
				.addGroup(gl_panel.createParallelGroup(Alignment.LEADING).addGroup(gl_panel.createSequentialGroup()
						...
						.addComponent(manageBlogsButton, GroupLayout.DEFAULT_SIZE, 130, Short.MAX_VALUE).addGap(12)
						.addComponent(dietConsultationButton)).addComponent(easyAccessLabel))
				.addContainerGap()));
		gl_panel.setVerticalGroup(gl_panel.createParallelGroup(Alignment.LEADING)
				.addGroup(gl_panel.createSequentialGroup().addContainerGap().addComponent(easyAccessLabel).addGap(10)
						.addGroup(gl_panel.createParallelGroup(Alignment.BASELINE)
								.addComponent(manageVideosButton, GroupLayout.DEFAULT_SIZE, 82, Short.MAX_VALUE)
								.addComponent(dietConsultationButton, GroupLayout.PREFERRED_SIZE, 82,
										GroupLayout.PREFERRED_SIZE)
								.addComponent(manageBlogsButton, GroupLayout.PREFERRED_SIZE, 82,
										GroupLayout.PREFERRED_SIZE))
						.addContainerGap()));
		...
		gl_statisticsPanel.setHorizontalGroup(gl_statisticsPanel
				.createParallelGroup(Alignment.LEADING).addGroup(gl_statisticsPanel.createSequentialGroup()
						.addContainerGap().addGroup(gl_statisticsPanel
								.createParallelGroup(Alignment.LEADING).addGroup(gl_statisticsPanel
										.createSequentialGroup()
										.addComponent(statisticsLabel, GroupLayout.PREFERRED_SIZE, 94,
												GroupLayout.PREFERRED_SIZE)
										.addGap(194).addComponent(calendarButton).addContainerGap())
								.addGroup(gl_statisticsPanel.createSequentialGroup().addGroup(gl_statisticsPanel
										...
										.addGroup(gl_statisticsPanel.createParallelGroup(Alignment.LEADING)
												.addGroup(gl_statisticsPanel.createParallelGroup(Alignment.LEADING)
														.addGroup(gl_statisticsPanel.createSequentialGroup()
																.addComponent(newUsersLabel, GroupLayout.DEFAULT_SIZE,
																		90, Short.MAX_VALUE)
																.addGap(82))
														.addGroup(gl_statisticsPanel.createSequentialGroup()
																...
																.addGap(92)))
												.addGroup(gl_statisticsPanel.createSequentialGroup()
														.addComponent(mostWatchedVideoLabel, GroupLayout.PREFERRED_SIZE,
																142, GroupLayout.PREFERRED_SIZE)
														.addGap(30)))
										.addGroup(
												gl_statisticsPanel
														.createSequentialGroup().addComponent(mostReadBlogLabel)
														.addGap(73)))
										.addGroup(gl_statisticsPanel.createParallelGroup(Alignment.LEADING)
												.addGroup(gl_statisticsPanel
												...
												.addGroup(gl_statisticsPanel
														.createParallelGroup(Alignment.TRAILING, false)
														.addComponent(mostReadBlogCountLabel, Alignment.LEADING,
																GroupLayout.DEFAULT_SIZE, GroupLayout.DEFAULT_SIZE,
																Short.MAX_VALUE)
														.addComponent(mostWatchedVideoCountLabel, Alignment.LEADING,
																GroupLayout.DEFAULT_SIZE, 100, Short.MAX_VALUE)))
										.addGap(378)))));
		gl_statisticsPanel.setVerticalGroup(gl_statisticsPanel.createParallelGroup(Alignment.LEADING)
				.addGroup(gl_statisticsPanel.createSequentialGroup().addContainerGap().addGroup(gl_statisticsPanel
						.createParallelGroup(Alignment.LEADING).addComponent(calendarButton)
						.addGroup(gl_statisticsPanel.createSequentialGroup().addComponent(statisticsLabel).addGap(27)
								.addGroup(gl_statisticsPanel.createParallelGroup(Alignment.BASELINE)
										.addComponent(newUsersLabel).addComponent(newUsersCountLabel))
								.addPreferredGap(ComponentPlacement.UNRELATED)
								.addGroup(gl_statisticsPanel.createParallelGroup(Alignment.BASELINE)
										.addComponent(activeUsersLabel, GroupLayout.PREFERRED_SIZE, 17,
												GroupLayout.PREFERRED_SIZE)
										.addComponent(activeUsersCountLabel))
								.addPreferredGap(ComponentPlacement.UNRELATED)
								.addGroup(gl_statisticsPanel.createParallelGroup(Alignment.BASELINE)
										.addComponent(mostWatchedVideoLabel, GroupLayout.PREFERRED_SIZE, 17,
												GroupLayout.PREFERRED_SIZE)
										.addComponent(mostWatchedVideoCountLabel))
								.addPreferredGap(ComponentPlacement.UNRELATED)
								.addGroup(gl_statisticsPanel.createParallelGroup(Alignment.BASELINE)
										.addComponent(mostReadBlogLabel, GroupLayout.PREFERRED_SIZE, 17,
												GroupLayout.PREFERRED_SIZE)
